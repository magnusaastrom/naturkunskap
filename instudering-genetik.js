/* =========================================================
   Instuderingsfrågor – Genetik (NK1b)
   Sida-specifik logik (metakognition + progress + tips)
   ========================================================= */
(() => {
  const STORAGE_KEY = 'nk1b_genetik_instudering_state_v1';
  const VALID_LEVELS = new Set(['can', 'unsure', 'cannot']);

  const AREA_LABELS = {
    cell: 'Cellens delar',
    protein: 'Proteinsyntesen',
    division: 'Celldelning',
    inheritance: 'Ärftlighet',
    evolution: 'Evolution & mutationer',
    genteknik: 'Genteknik'
  };

  const SKILL_MAP = {
    'dna-gener-kromosomer': ['q1', 'q2'],
    organeller: ['q3'],
    proteinsyntes: ['q4', 'q5', 'q6'],
    'mitos-meios': ['q7', 'q8', 'q9'],
    'dominant-recessiv': ['q10', 'q11', 'q14'],
    korsningsschema: ['q12'],
    'kodominans-intermediar': ['q13'],
    'mutationer-urval': ['q15', 'q16', 'q17'],
    genteknik: ['q18']
  };
